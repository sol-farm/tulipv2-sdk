...
exports.deriveSunnyVaultAddress =
  exports.deriveQuarryVaultConfigDataAddress =
  exports.deriveQuarryVaultRewardTokenAccount =
  exports.deriveQuarryMinerAddress =
  exports.deriveOrcaDDWithdrawQueueAddress =
  exports.deriveEphemeralTrackingAddress =
  exports.deriveMultiDepositStateTransitionAddress =
  exports.deriveTrackingOrcaDDQueueAddress =
  exports.deriveOrcaDDCompoundQueueAddress =
  exports.deriveOrcaUserFarmAddress =
  exports.deriveMangoAccountAddress =
  exports.deriveLendingPlatformConfigDataAddress =
  exports.deriveLndingPlatformInformationAccountAddress =
  exports.deriveLendingPlatformAccountAddress =
  exports.findAssociatedStakeInfoAddress =
  exports.createAssociatedTokenAccount =
  exports.deriveTrackingQueueAddress =
  exports.deriveTrackingPdaAddress =
  exports.deriveTrackingAddress =
  exports.deriveSerumFeeRecipientAddress =
  exports.deriveSerumTradeOpenOrdersAddress =
  exports.deriveSerumTradePdaAddress =
  exports.deriveSerumTradeAccount =
  exports.deriveCompoundQueueAddress =
  exports.deriveWithdrawQueueAddress =
  exports.deriveRaydiumUserStakeInfoAddress =
  exports.deriveSharesMintAddress =
  exports.deriveVaultPdaAddress =
  exports.deriveVaultAddress =
  exports.deriveManagementAddress =
    void 0;
...
function deriveSerumTradeOpenOrdersAddress(
  programId,
  tradeAccount,
  serumMarket
) {
...
function createAssociatedTokenAccount(
  ...
  return __awaiter(this, void 0, void 0, function* () {
    ...
    tx.add(
      yield serumAssoToken.createAssociatedTokenAccount(
...
function deriveLendingPlatformAccountAddress(
  vaultPda,
  lendingMarket,
  programId
) {
...
function deriveLndingPlatformInformationAccountAddress(
  vault,
  index,
  programId
) {
...
function deriveQuarryVaultRewardTokenAccount(
  vault,
...
exports.deriveQuarryVaultRewardTokenAccount =
  deriveQuarryVaultRewardTokenAccount;
