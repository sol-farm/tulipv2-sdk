...
describe("examples", () => {
  ...
  it("registers deposit tracking account", () =>
    __awaiter(void 0, void 0, void 0, function* () {
      console.log("progrmaId ", programId);
      console.log("usdcv1 vault ", usdcv1Vault);
      console.log("provider", provider.wallet.publicKey);
      let [_depositTrackingAccount, _trackingNonce] = yield (0,
      utils_1.deriveTrackingAddress)(
        v2VaultsProgramId,
        usdcv1Vault,
        provider.wallet.publicKey
      );
      depositTrackingAccount = _depositTrackingAccount;
      let [_depositTrackingPda, _depositTrackingPdaNonce] = yield (0,
      utils_1.deriveTrackingPdaAddress)(
        v2VaultsProgramId,
        depositTrackingAccount
      );
      depositTrackingPda = _depositTrackingPda;
      let [_depositTrackingQueueAccount, _queueNonce] = yield (0,
      utils_1.deriveTrackingQueueAddress)(
        v2VaultsProgramId,
        depositTrackingPda
      );
      depositTrackingQueueAccount = _depositTrackingQueueAccount;
      depositTrackingHoldAccount =
        yield serumAssoToken.getAssociatedTokenAddress(
          depositTrackingPda,
          usdcv1SharesMint
        );
      ...
      let tx = yield program.methods
        .registerDepositTrackingAccount([
          new anchor.BN(1),
          new anchor.BN(65537),
        ])
        .accounts({
        ...
        .signers(anchor.workspace.provider.wallet)
        .rpc();
      console.log("sent register deposit tracking account tx ", tx);
    }));
  it("issues shares", () =>
    __awaiter(void 0, void 0, void 0, function* () {
      yourUnderlyingTokenAccount = yield (0,
      utils_1.createAssociatedTokenAccount)(
        provider,
        provider.wallet.publicKey,
        usdcTokenMint
      );
      yourSharesTokenAccount = yield (0, utils_1.createAssociatedTokenAccount)(
        provider,
        provider.wallet.publicKey,
        usdcv1SharesMint
      );
      let tx = yield program.methods
        .issueShares(new anchor.BN(0))
        .accounts({
          authority: provider.wallet.publicKey,
          vault: usdcv1Vault,
          depositTrackingAccount,
  ...
  it("withdraws from deposit tracking account", () =>
    __awaiter(void 0, void 0, void 0, function* () {
      let tx = yield program.methods
        .withdrawDepositTracking(new anchor.BN(0))
        .accounts({
          authority: provider.wallet.publicKey,
          depositTrackingAccount,
          depositTrackingPda,
  ...
  it("withdraws multi deposit vault through mango", () =>
    __awaiter(void 0, void 0, void 0, function* () {
      let tx = yield program.methods
        .withdrawMultiDepositVaultThroughMango(new anchor.BN(0))
        .accounts({
          commonData: {
            authority: provider.wallet.publicKey,
  ...
  it("withdraws multi deposit vault through solend", () =>
    __awaiter(void 0, void 0, void 0, function* () {
      let tx = yield program.methods
        .withdrawMultiDepositVaultThroughSolend(new anchor.BN(0))
        .accounts({
          commonData: {
            authority: provider.wallet.publicKey,
            multiVault: usdcv1Vault,
  ...
  it("withdraws multi deposit vault through solend", () =>
    __awaiter(void 0, void 0, void 0, function* () {
      let tx = yield program.methods
        .withdrawMultiDepositVaultThroughTulip(new anchor.BN(0))
        .accounts({
          commonData: {
            authority: provider.wallet.publicKey,
            multiVault: usdcv1Vault,
