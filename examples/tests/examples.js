...
describe('examples', () => {
    ...
    it('registers deposit tracking account', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        let tx = yield program.methods.registerDepositTrackingAccount([
    ...
    it("withdraws from deposit tracking account", () => __awaiter(void 0, void 0, void 0, function* () {
        let tx = yield program.methods.withdrawDepositTracking(new anchor.BN(0)).accounts({
            authority: provider.wallet.publicKey,
            depositTrackingAccount,
            depositTrackingPda,
            depositTrackingHoldAccount,
    ...
    it("withdraws multi deposit vault through mango", () => __awaiter(void 0, void 0, void 0, function* () {
        let tx = yield program.methods.withdrawMultiDepositVaultThroughMango(new anchor.BN(0)).accounts({
            commonData: {
                authority: provider.wallet.publicKey,
    ...
    it("withdraws multi deposit vault through solend", () => __awaiter(void 0, void 0, void 0, function* () {
        let tx = yield program.methods.withdrawMultiDepositVaultThroughSolend(new anchor.BN(0)).accounts({
            commonData: {
                authority: provider.wallet.publicKey,
                multiVault: usdcv1Vault,
                multiVaultPda: usdcv1VaultPda,
    ...
    it("withdraws multi deposit vault through solend", () => __awaiter(void 0, void 0, void 0, function* () {
        let tx = yield program.methods.withdrawMultiDepositVaultThroughTulip(new anchor.BN(0)).accounts({
            commonData: {
                authority: provider.wallet.publicKey,
                multiVault: usdcv1Vault,
                multiVaultPda: usdcv1VaultPda,
