...
pub mod farm_config {
    ...
    pub const BASE_TOKEN_ACCOUNT: Pubkey = static_pubkey!("2BADq6FU8HpaLp3deEsrP4ErnUjiCyMpfszccNQUjT1v");
    pub const QUOTE_TOKEN_ACCOUNT: Pubkey = static_pubkey!("9JDCPWh1YrUKXJonTgdpagB9CHfs3kHdvec5nAKP2vU6");
}
...
pub mod vault_config {
    ...
    pub const REWARD_A_TOKEN_ACCOUNT: Pubkey = static_pubkey!("1ZpdBUTiDLTUe3izSdYfRXSf93fpJPmoKtA5bFjGesS");
    pub const POOL_REWARD_A_TOKEN_ACCOUNT: Pubkey = static_pubkey!("HCHNuGzkqSnw9TbwpPv1gTnoqnqYepcojHw9DAToBrUj");
    pub const POOL_REWARD_B_TOKEN_ACCOUNT: Pubkey = static_pubkey!("HCHNuGzkqSnw9TbwpPv1gTnoqnqYepcojHw9DAToBrUj");
    pub const REWARD_B_TOKEN_ACCOUNT: Pubkey = static_pubkey!("3GvyLReVXibBoHjfFrxa3ubBVdjp9uR5rJYzN5trjT5F");
    pub const POOL_AUTHORITY: Pubkey = static_pubkey!("8JYVFy3pYsPSpPRsqf43KSJFnJzn83nnRLQgG88XKB8q");
    pub const LP_TOKEN_ACCOUNT: Pubkey = static_pubkey!("GoW9fQtCrX1Bd4abWzETcpewbeCyQQWEWCyWmnQg3coK");
    // set to this if not used
    // pub const OLD_VAULT_INFO: Pubkey = DEFAULT_KEY;
    pub const OLD_VAULT_INFO_ACCOUNT: Pubkey = DEFAULT_KEY;
    pub const VAULT_INFO_ACCOUNT: Pubkey = static_pubkey!("Bo8xiDzWWJgGgjG1YMriLT6hNkQX7NzeeemjkmXiwJmp");
}
...
pub mod market_config {
    ...
    pub const SERUM_REQUEST_QUEUE: Pubkey = static_pubkey!("8RrrYN9WtASWGv9KfC5maF6AKxT6GSCikZ8SkSaimGZa");
    pub const SERUM_EVENT_QUEUE: Pubkey = static_pubkey!("58KcficuUqPDcMittSddhT8LzsPJoH46YP4uURoMo5EB");
    ...
    pub const SERUM_COIN_VAULT: Pubkey = static_pubkey!("2kVNVEgHicvfwiyhT2T51YiQGMPFWLMSp8qXc1hHzkpU");
    pub const SERUM_PC_VAULT: Pubkey = static_pubkey!("5AXZV7XfR7Ctr6yjQ9m9dbgycKeUXWnWqHwBTZT6mqC7");
    pub const SERUM_FEE_RECEIVER: Pubkey = static_pubkey!("F2szJdBzeiYNb45Ysd8ufsjdh8csEbXv1HaTrG4Tyv2R");
    pub const SERUM_OPEN_ORDERS: Pubkey = static_pubkey!("DhCYkD7AhiH6zUmmFc4PVXTw6eKxh2bbTWs1t7BgAA2P");
    pub const SERUM_VAULT_SIGNER: Pubkey = static_pubkey!("HzWpBN6ucpsA9wcfmhLAFYqEUmHjE9n2cGHwunG5avpL");
    ...
    pub const PC_TOKEN_MINT: Pubkey = static_pubkey!("Es9vMFrzaCERmJfrF4H2FYD4KCoNkY11McCe8BenwNYB");
    pub const AMM_ID: Pubkey = static_pubkey!("DVa7Qmb5ct9RCpaU7UTpSaf3GVMYz17vNVU67XpdCRut");
    pub const AMM_OPEN_ORDERS: Pubkey = static_pubkey!("7UF3m8hDGZ6bNnHzaT2YHrhp7A7n9qFfBj6QEpHPv5S8");
    pub const AMM_QUANTITIES_OR_TARGET_ORDERS: Pubkey = static_pubkey!("3K2uLkKwVVPvZuMhcQAPLF8hw95somMeNwJS7vgWYrsJ");
    pub const AMM_COIN_ACCOUNT: Pubkey = static_pubkey!("3wqhzSB9avepM9xMteiZnbJw75zmTBDVmPFLTQAGcSMN");
    pub const AMM_PC_ACCOUNT: Pubkey = static_pubkey!("5GtSbKJEPaoumrDzNj4kGkgZtfDyUceKaHrPziazALC1");
    pub const AMM_TEMP_ACCOUNT: Pubkey = static_pubkey!("FBzqDD1cBgkZ1h6tiZNFpkh4sZyg6AG8K5P9DSuJoS5F");
    pub const AMM_WITHDRAW_QUEUE: Pubkey = static_pubkey!("8VuvrSWfQP8vdbuMAP9AkfgLxU9hbRR6BmTJ8Gfas9aK");
...
pub mod reserve_config {
    ...
    pub const PYTH_LP_PRICE_ACCOUNT: Pubkey = static_pubkey!("8m4XxNbrpFLRahQrbkDcdudPQsmUk3rotgkY9yNR4uA6");
    pub const PYTH_COIN_PRICE_ACCOUNT: Pubkey = static_pubkey!("83fYH17UZaTCpr6GNcPcS5pZkfxwR1CaEVhYKfkqE8YF");
    pub const PYTH_PC_PRICE_ACCOUNT: Pubkey = static_pubkey!("uo3MK2mD9KogjNLxTWVaB5XqA9Hg4mx4QuRm9SRtKdE");
    pub const COIN_RESERVE_FEE_RECEIVER: Pubkey = static_pubkey!("4bRQL2hLqfinNJTsiQW6odhYtYjKXH7zsPc2tafadgoj");
    pub const PC_RESERVE_FEE_RECEIVER: Pubkey = static_pubkey!("3VQV6yjMUXaTcR6KCvZSAgEKkvZUVEQnNdyEREPbjj31");
    pub const BASE_RESERVE: Pubkey = static_pubkey!("9Bm8d2izGsf9eT6Wr79DTnXBkW2LHYVQa57QzeoTbsAF");
    pub const QUOTE_RESERVE: Pubkey = static_pubkey!("Csn3exasdhDzxYApmnci3d8Khb629VmgK4NQqdeyZBNt");
    pub const BASE_RESERVE_LIQUIDITY_SUPPLY: Pubkey = static_pubkey!("9SG6E3jBTTHLNgpV6ueUYypMYMkm4K5zyS9tk9Rsjm8Y");
    pub const QUOTE_RESERVE_LIQUIDITY_SUPPLY: Pubkey = static_pubkey!("124J21csiR1FdDywteXa8LhAmeqBXZRvozhoE7zq9znc");
    pub const BASE_RESERVE_COLLATERAL_MINT: Pubkey = static_pubkey!("8Lg7TowFuMQoGiTsLE6qV9x3czRgDmVy8f8Vv8KS4uW");
    pub const QUOTE_RESERVE_COLLATERAL_MINT: Pubkey = static_pubkey!("gLhY2arqFpmVGkpbBbTi3TeWbsWevA8dqrwbKacK3vJ");
}
