...
pub mod farm_config {
    ...
    pub const VAULT_ACCOUNT: Pubkey = static_pubkey!("91M42pKURwf4VQHACzx1VFZ8PGZgW2RDwPkwbBk8peGU");
    pub const BASE_TOKEN_ACCOUNT: Pubkey = static_pubkey!("3HHbo1CWtnrLVjcnEhGPjhguG7D2p91pxKAf12WeTj8t");
    pub const QUOTE_TOKEN_ACCOUNT: Pubkey = static_pubkey!("52AXPLa2k2eDL9i4mwhPFdEC765HsJFKDGJKhYTCRxWj");
}
...
pub mod vault_config {
    ...
    pub const REWARD_A_TOKEN_ACCOUNT: Pubkey = static_pubkey!("EBG35vxzKwWs58WJgnUdcMboSX5GfK5YmJPj1jZLpx2g");
    pub const POOL_REWARD_A_TOKEN_ACCOUNT: Pubkey = static_pubkey!("38YS2N7VUb856QDsXHS1h8zv5556YgEy9zKbbL2mefjf");
    pub const POOL_REWARD_B_TOKEN_ACCOUNT: Pubkey = static_pubkey!("ANDJUfDryy3jY6DngwGRXVyxCJBT5JfojLDXwZYSpnEL");
    pub const REWARD_B_TOKEN_ACCOUNT: Pubkey = static_pubkey!("BHsQPgxquqT2pBsYaNmsbUNuAg8QMkgWS51E1z2miLbd");
    pub const POOL_AUTHORITY: Pubkey = static_pubkey!("DgbCWnbXg43nmeiAveMCkUUPEpAr3rZo3iop3TyP6S63");
    pub const LP_TOKEN_ACCOUNT: Pubkey = static_pubkey!("J6ECnRDZEXcxuruvErXDWsPZn9czowKynUr9eDSQ4QeN");
    // set to this if not used
    // pub const OLD_VAULT_INFO: Pubkey = DEFAULT_KEY;
    pub const VAULT_INFO_ACCOUNT: Pubkey = static_pubkey!("HB1FUY2CkPC9W4xrc8FLEbzTwqo23ErBRGuLwoaoAdYW");
}
...
pub mod market_config {
    ...
    pub const SERUM_REQUEST_QUEUE: Pubkey = static_pubkey!("AZG3tFCFtiCqEwyardENBQNpHqxgzbMw8uKeZEw2nRG5");
    pub const SERUM_EVENT_QUEUE: Pubkey = static_pubkey!("5KKsLVU6TcbVDK4BS6K1DGDxnh4Q9xjYJ8XaDCG5t8ht");
    ...
    pub const SERUM_COIN_VAULT: Pubkey = static_pubkey!("36c6YqAwyGKQG66XEp2dJc5JqjaBNv7sVghEtJv4c7u6");
    pub const SERUM_PC_VAULT: Pubkey = static_pubkey!("8CFo8bL8mZQK8abbFyypFMwEDd8tVJjHTTojMLgQTUSZ");
    pub const SERUM_FEE_RECEIVER: Pubkey = static_pubkey!("PgjTxGVTmFGQjGX8DrETmT68hRt6Jyps4SFTnxJcf3S");
    pub const SERUM_OPEN_ORDERS: Pubkey = static_pubkey!("5XAxLutApKRQ9WTtRNPpRq2btQkqF94Ezsh2mAQ7uqhR");
    pub const SERUM_VAULT_SIGNER: Pubkey = static_pubkey!("F8Vyqk3unwxkXukZFQeYyGmFfTG3CAX4v24iyrjEYBJV");
    pub const LP_MINT: Pubkey = static_pubkey!("8HoQnePLqPj4M7PUDzfw8e3Ymdwgc7NLGnaTUapubyvu");
    pub const COIN_TOKEN_MINT: Pubkey = static_pubkey!("So11111111111111111111111111111111111111112");
    ...
    pub const AMM_OPEN_ORDERS: Pubkey = static_pubkey!("HRk9CMrpq7Jn9sh7mzxE8CChHG8dneX9p475QKz4Fsfc");
    pub const AMM_QUANTITIES_OR_TARGET_ORDERS: Pubkey = static_pubkey!("CZza3Ej4Mc58MnxWA385itCC9jCo3L1D7zc3LKy1bZMR");
    pub const AMM_COIN_ACCOUNT: Pubkey = static_pubkey!("DQyrAcCrDXQ7NeoqGgDCZwBvWDcYmFCjSb9JtteuvPpz");
    pub const AMM_PC_ACCOUNT: Pubkey = static_pubkey!("HLmqeL62xR1QoZ1HKKbXRrdN1p3phKpxRMb2VVopvBBz");
    pub const AMM_TEMP_ACCOUNT: Pubkey = static_pubkey!("Awpt6N7ZYPBa4vG4BQNFhFxDj4sxExAA9rpBAoBw2uok");
    pub const AMM_WITHDRAW_QUEUE: Pubkey = static_pubkey!("G7xeGGLevkRwB5f44QNgQtrPKBdMfkT6ZZwpS9xcC97n");
