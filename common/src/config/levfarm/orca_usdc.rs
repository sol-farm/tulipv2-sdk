...
pub mod farm_config {
    ...
    pub const VAULT_ACCOUNT: Pubkey = static_pubkey!("2Dts63SfTz2yivx57izMcVfDMAdpxuBgqM99ChWeJXun");
    pub const BASE_TOKEN_ACCOUNT: Pubkey = static_pubkey!("HGkRMx91bZzzcbvJVyzWgDAswHA7Rhn11tuox9GYTB5c");
    pub const QUOTE_TOKEN_ACCOUNT: Pubkey = static_pubkey!("E68tCFxPPFZa6VWb6d6Txe7ugzF977TZvoVF59W951gv");
}
...
pub mod vault_config {
    ...
    pub const AQUA_FARM_BASE_TOKEN_MINT: Pubkey = static_pubkey!("n8Mpu28RjeYD7oUX3LG1tPxzhRZh3YYLRSHcHRdS3Zx");
    pub const AQUA_FARM_BASE_TOKEN_VAULT: Pubkey = static_pubkey!("45BAAQCZYd2kP3Z3WvRwdtfUhvuW4FvpqVK4m8qrR5x1");
    pub const AQUA_FARM_REWARD_TOKEN_MINT: Pubkey = static_pubkey!("orcaEKTdK7LKz57vaAYr9QeNsVEPfiu6QeMU1kektZE");
    pub const AQUA_FARM_REWARD_TOKEN_VAULT: Pubkey = static_pubkey!("DEiqe2Ta9TRMRtWdBqiFV13dhVrqCeG8MMmVwywvXvJo");
    pub const FARM_TOKEN_MINT: Pubkey = static_pubkey!("Gc7W5U66iuHQcC1cQyeX9hxkPF2QUVJPTf1NWbW8fNrt");

    pub const VAULT_REWARD_TOKEN_ACCOUNT: Pubkey = static_pubkey!("82EjQKzz74AndA144SA1RC57puyjsDHggwmPs9VXbH5s");
    pub const VAULT_SWAP_POOL_TOKEN_ACCOUNT: Pubkey = static_pubkey!("JCGNW8e3V4ADCiCWU42BTF3FHJLidfgcxHYo2m7kDYvN");
    pub const VAULT_SWAP_POOL_TOKEN_A_ACCOUNT: Pubkey = static_pubkey!("82EjQKzz74AndA144SA1RC57puyjsDHggwmPs9VXbH5s");
    pub const VAULT_SWAP_POOL_TOKEN_B_ACCOUNT: Pubkey = static_pubkey!("8cNdAEu4y6KRWZwekBavQRpQbYBYNAmNCB8xTJgWibz1");
    pub const VAULT_DEPOSIT_QUEUE: Pubkey = static_pubkey!("GEogPAbFyMyUuxjjgMDBh1of9qaz5BGEtTyYX9LVDfSA");
}
...
pub mod market_config {
    ...
    pub const SERUM_COIN_VAULT: Pubkey = static_pubkey!("9vYWHBPz817wJdQpE8u3h8UoY3sZ16ZXdCcvLB7jY4Dj");
    pub const SERUM_PC_VAULT: Pubkey = static_pubkey!("6UczejMUv1tzdvUzKpULKHxrK9sqLm8edR1v9jinVWm9");
    pub const SERUM_FEE_RECEIVER: Pubkey = static_pubkey!("7CXZED4jfRp3qdHB9Py3up6v1C4UhHofFvfT6RXbJLRN");
    ...
    pub const COIN_TOKEN_MINT: Pubkey = static_pubkey!("orcaEKTdK7LKz57vaAYr9QeNsVEPfiu6QeMU1kektZE");
    ...
    pub const AMM_QUANTITIES_OR_TARGET_ORDERS: Pubkey = static_pubkey!("11111111111111111111111111111111");
    pub const AMM_COIN_ACCOUNT: Pubkey = static_pubkey!("9vYWHBPz817wJdQpE8u3h8UoY3sZ16ZXdCcvLB7jY4Dj");
    pub const AMM_PC_ACCOUNT: Pubkey = static_pubkey!("6UczejMUv1tzdvUzKpULKHxrK9sqLm8edR1v9jinVWm9");
    ...
    pub const AMM_AUTHORITY: Pubkey = static_pubkey!("3fr1AhdiAmWLeNrS24CMoAu9pPgbzVhwLtJ6QUPmw2ob");
}
...
pub mod reserve_config {
    ...
    pub const PYTH_LP_PRICE_ACCOUNT: Pubkey = static_pubkey!("8VAsQbfX5jPGTPWqAdK6qm42erK299oe86jHM3dnDVtp");
    pub const PYTH_COIN_PRICE_ACCOUNT: Pubkey = static_pubkey!("ELHiqZR2cYkN2MerbfMSWGy3nwdPuHYiXbiKsQG7Uy9p");
    pub const PYTH_PC_PRICE_ACCOUNT: Pubkey = static_pubkey!("ExzpbWgczTgd8J58BrnESndmzBkRVfc6PhFjSGiQXgAB");
    pub const COIN_RESERVE_FEE_RECEIVER: Pubkey = static_pubkey!("ADz1SJ28TH2TnLzA9FG7DqiW41CKeLfRvbvDckK1dvFv");
    ...
    pub const BASE_RESERVE_LIQUIDITY_SUPPLY: Pubkey = static_pubkey!("4LqykQes5scGz4bZLNaNm1bmgMutCCGqQZVni4VJjWhZ");
    pub const QUOTE_RESERVE_LIQUIDITY_SUPPLY: Pubkey = static_pubkey!("64QJd6MYXUjCBvCaZKaqxiKmaMkPUdNonE1KuY1YoGGb");
    pub const BASE_RESERVE_COLLATERAL_MINT: Pubkey = static_pubkey!("HRYfSMc1gYEvxo9zsh14jYHKxAcfJfoVakKtRtJEomb8");
