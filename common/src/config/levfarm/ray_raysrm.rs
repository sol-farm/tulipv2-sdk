...
pub mod farm_config {
    ...
    pub const VAULT_ACCOUNT: Pubkey = static_pubkey!("EkePqacuxaubJJxCYW9RxqyXc1r4LzLJTRfF4bW64UQv");
    pub const BASE_TOKEN_ACCOUNT: Pubkey = static_pubkey!("kVLZnvKQS7951uDqoDn6eSsJ8aj4WTFB2hP3dq4GTqm");
    pub const QUOTE_TOKEN_ACCOUNT: Pubkey = static_pubkey!("CCE919uwcutmQZBxEzYRfTKYwmufaYWhzXeawEZyjPPD");
}
...
pub mod vault_config {
    ...
    pub const LP_TOKEN_ACCOUNT: Pubkey = static_pubkey!("9jngyDQiEhYh7RWVS5SCJnyhN3kPjG8rJBJeKcFGs9eB");
    // set to this if not used
    // pub const OLD_VAULT_INFO: Pubkey = DEFAULT_KEY;
    pub const OLD_VAULT_INFO_ACCOUNT: Pubkey = static_pubkey!("36ckujxHmZLyqvzfT5wE94tHEgYfMkChPKAhkGUyGkYW");
    pub const VAULT_INFO_ACCOUNT: Pubkey = static_pubkey!("8RGsvBeGytCzpf8jfFSbLygvSSLsb4tPgqqQqvyrXfKx");
}
...
pub mod market_config {
    ...
    pub const SERUM_REQUEST_QUEUE: Pubkey = static_pubkey!("8nd4pSGRFepzj4KRCVpwxdMGNUJVUoa8NcHYEnt99NEn");
    pub const SERUM_EVENT_QUEUE: Pubkey = static_pubkey!("4afBYfMNsNpLQxFFt72atZsSF4erfU28XvugpX6ugvr1");
    ...
    pub const AMM_OPEN_ORDERS: Pubkey = static_pubkey!("7XWbMpdyGM5Aesaedh6V653wPYpEswA864sBvodGgWDp");
    pub const AMM_QUANTITIES_OR_TARGET_ORDERS: Pubkey = static_pubkey!("9u8bbHv7DnEbVRXmptz3LxrJsryY1xHqGvXLpgm9s5Ng");
    pub const AMM_COIN_ACCOUNT: Pubkey = static_pubkey!("3FqQ8p72N85USJStyttaohu1EBsTsEZQ9tVqwcPWcuSz");
    pub const AMM_PC_ACCOUNT: Pubkey = static_pubkey!("384kWWf2Km56EReGvmtCKVo1BBmmt2SwiEizjhwpCmrN");
    pub const AMM_TEMP_ACCOUNT: Pubkey = static_pubkey!("8jqpuijsM2ne5dkwLyjQxa9oCbYEjM6bE1uBaFXmC3TE");
    pub const AMM_WITHDRAW_QUEUE: Pubkey = static_pubkey!("58z15NsT3JJyfywFbdYzn2GVeDDC444WHyUrssZ5tCm7");
